sap.ui.define([
	...
	return Controller.extend("pg.kanban.controller.BaseController", {
		/**
		...
		/**
		 * Function that gets the i18n text
		 * @public
		 **/
		geti18nText: function (sText, aParam) {
			if (!this.oI18n) {
				this.oI18n = this.getOwnerComponent().getModel("i18n");
			}
			return this.oI18n.getResourceBundle().getText(sText, aParam);
		}
	});
